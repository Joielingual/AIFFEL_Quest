...
페이스북, 인스타그램 등 메타 서비스를 이용하면서 시스템이 자동화되어있고, 사람이 일하는 것 같지 않다는 느낌을 자주 받았었다. 메타는 일단 고객센터가 존재하지 않기 때문에... 기업 입장에서는 인건비를 절감하고 기업 운영에 자원을 덜 소비하다보니 편하겠지만 소비자 입장에선 불편하기도 했었어서, 이것이 한계인가 싶기도 하다!

인공지능에 대중들 관심이 쏠린지는 오래 되었지만, 요즘은 확실히 다른 느낌으로 움직임이 일고 있는 것 같다. 스타트업에서 일하고 싶은 사람으로.. 지식을 다루고 싶지만 가치를 수출하려면 필수적인 게 또 인공지능인듯 하다.
